...
public class Constants {
    ...
    public static final String PLAYER_PACKAGE_NAME = "com.koma.mediacategory";
    public static final String PLAYER_CLASS_NAME = "com.koma.mediacategory.video.player.VideoPlayerActivity";
}
